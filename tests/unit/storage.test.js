...
describe('Unit: storage module', () => {
  ...
  describe('readAvailableVersions', () => {
    it('should return empty array when file does not exist', async () => {
      const { readAvailableVersions } = await import(
        '../../src/lib/storage.js'
      );
  ...
  describe('writeAvailableVersions', () => {
    it('should write data to available.json', async () => {
      ...
      const { writeAvailableVersions } = await import(
        '../../src/lib/storage.js'
      );
  ...
  describe('readInstalledVersions', () => {
    it('should return empty object when file does not exist', async () => {
      const { readInstalledVersions } = await import(
        '../../src/lib/storage.js'
      );
  ...
  describe('writeInstalledVersions', () => {
    it('should write data to installed.json', async () => {
      ...
      const { writeInstalledVersions } = await import(
        '../../src/lib/storage.js'
      );
  ...
  describe('addInstalledVersion', () => {
    it('should add a version to installed.json', async () => {
      const { addInstalledVersion, readInstalledVersions } = await import(
        '../../src/lib/storage.js'
      );
  ...
  describe('removeInstalledVersion', () => {
    it('should remove a version from installed.json', async () => {
      ...
      const { removeInstalledVersion, readInstalledVersions } = await import(
        '../../src/lib/storage.js'
      );
    ...
    it('should not fail if version does not exist', async () => {
      const { removeInstalledVersion } = await import(
        '../../src/lib/storage.js'
      );
