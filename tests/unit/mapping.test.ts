...
describe('Unit: mapping module', () => {
  ...
  describe('mergeRevisionsWithVersions', () => {
    ...
    it('should handle revisions without version mappings', async () => {
      ...
      const versionMappings: Array<{ version: string; chromium_main_branch_position: number; channel: string; platform: string }> = [];
    ...
    it('should deduplicate entries', async () => {
      ...
      const revisionCounts: Record<string, number> = merged.reduce((acc: Record<string, number>, item) => {
  ...
  describe('resolveVersion', () => {
    it('should resolve "latest" to highest version', async () => {
      ...
      const available = [
        { version: '92.0.4515.159', revision: '882387', channel: 'Stable', platform: 'Mac_Arm', hasVersion: true },
        { version: '93.0.4577.82', revision: '911515', channel: 'Stable', platform: 'Mac_Arm', hasVersion: true },
        { version: '91.0.4472.124', revision: '870763', channel: 'Stable', platform: 'Mac_Arm', hasVersion: true }
      ];
