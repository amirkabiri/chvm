 ...
 */
export function runCLI(args = '', options: RunCLIOptions = {}): string | CLIErrorResult {
 ...
 */
export function createMockAvailable(chvmHome: string, versions: MockVersion[]): string {
 ...
 */
export function createMockInstalled(chvmHome: string, versions: Record<string, any>): string {
 ...
 */
export function createMockAppBundle(appPath: string, options: MockAppBundleOptions = {}): string {
 ...
 */
export async function waitFor(condition: () => Promise<boolean> | boolean, options: WaitForOptions = {}): Promise<boolean> {
 ...
 */
export function assertOutputContains(output: string | CLIErrorResult, patterns: string | RegExp | Array<string | RegExp>): void {
