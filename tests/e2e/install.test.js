...
describe('E2E: chvm install', () => {
  ...
  it('should support installing by revision number', async () => {
    ...
    expect(output).toMatch(
      /882387|92\.0\.4515\.159|Downloading|Installing|Resolving/i
    );
  ...
  it('should support installing by version number', async () => {
    ...
    expect(output).toMatch(
      /92\.0\.4515\.159|882387|Downloading|Installing|Resolving/i
    );
  }, 120000);
  ...
  it('should support "latest" keyword', async () => {
    ...
    expect(output).toMatch(
      /latest|115\.0\.5790\.170|1234567|Resolving|Installing/i
    );
  }, 120000);
  ...
  it('should support "oldest" keyword', async () => {
    ...
    expect(output).toMatch(
      /oldest|92\.0\.4515\.159|882387|Resolving|Installing/i
    );
  }, 120000);
